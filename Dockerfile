...
COPY --chown=dev:dev . /workspace/a-json-schema-builder-library
RUN mkdir -p /workspace/build/a-json-schema-builder-library && \
    cd /workspace/build/a-json-schema-builder-library && \
    cmake /workspace/a-json-schema-builder-library && \
